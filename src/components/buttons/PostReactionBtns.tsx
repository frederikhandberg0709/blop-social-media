...
const PostReactionBtns: React.FC<PostReactionBtnsProps> = ({
  ...
  return (
    <div className="flex gap-[15px]">
      <button className="flex items-center justify-center gap-[5px] w-[90px] py-[3px] rounded-full fill-red-500 hover:bg-red-500/25 active:bg-red-500/50 cursor-pointer transition-colors duration-200">
        {/* Like icon */}
        <svg
          width="24"
          height="24"
      ...
      <button className="flex items-center justify-center gap-[5px] w-[90px] py-[3px] rounded-full fill-blue-500 hover:bg-blue-500/25 active:bg-blue-500/50 cursor-pointer transition-colors duration-200">
        {/* Comment icon */}
        <svg
          width="24"
          height="24"
      ...
      <button className="flex items-center justify-center gap-[5px] w-[90px] py-[3px] rounded-full fill-green-500 hover:bg-green-500/25 active:bg-green-500/50 cursor-pointer transition-colors duration-200">
        {/* Share icon */}
        <svg
          width="24"
          height="24"

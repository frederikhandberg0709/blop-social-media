    ...
    <div className="flex gap-[15px]">
      <Tooltip text={liked ? "Unlike" : "Like"} position="top" offset="40">
        ...
        >
          ...
          <span className="select-none text-base">{likesCount}</span>
        </button>
      </Tooltip>
      <Tooltip
      ...
      >
        ...
        >
          ...
          <span className="select-none text-base">{commentsCount}</span>
        </button>
      </Tooltip>
      <Tooltip text={"Share"} position="top" offset="40">
        ...
        >
          ...
          <span className="select-none text-base">{sharesCount}</span>
        </button>
      </Tooltip>
    </div>
  );
